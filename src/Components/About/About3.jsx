...
function About3() {
  ...
  return (
    <div className='objetivosContainer' id='objetivos'>
            <h2>Objetivos</h2>
        <div className='objetivosBoxesContainer'>

            <div>
                <h6 className='objetivosTitle firstBorder'> <AutoFixHighOutlinedIcon className='objetivosIcon' /> Servicio de excelencia</h6>
            ...
            <div>
                <h6 className='objetivosTitle lastBorder'> <RocketLaunchOutlinedIcon className='objetivosIcon' /> Expansión</h6>
